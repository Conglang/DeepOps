...
from model.input_fn import test_input_fn, test_datas
from model.model_fn import model_fn

from sprite_generator import make_sprite
...
if __name__ == '__main__':
    ...
    embeddings = np.zeros((len(labels), params.embedding_size))
    ...
    embedding_var = tf.Variable(embeddings, name='casia_embedding')
    ...
    metadata_filename = "casia_metadata.tsv"
